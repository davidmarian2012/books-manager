        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutorNume = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IdAutor = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdPremiu = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartiPremii", x => new { x.IdCarte, x.IdPremiu });
                    table.ForeignKey(
                        name: "FK_CartiPremii_Carti_IdCarte",
                        column: x => x.IdCarte,
                        principalTable: "Carti",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartiPremii_Premii_IdPremiu",
                        column: x => x.IdPremiu,
                        principalTable: "Premii",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
